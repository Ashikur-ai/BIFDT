...
const Footer = () => {
    return (
        <>
            <footer className="footer p-10 bg-pink-700 text-neutral-content">
                <aside>
                    <img src={logo} className="pl-10 w-2/3" alt="" />
                    {/* <div className="flex gap-2">
                        <FaPhoneSquare /><p>016-29-17-17-17,</p>                        
                    </div>

                    <div className="flex gap-2">
                        <FaPhoneSquare /><p>016-29-18-18-18,</p>                        
                    </div>
                    <div className="flex gap-2">
                        <FaPhoneSquare /><p>016-29-18-18-18</p>                        
                    </div> */}
