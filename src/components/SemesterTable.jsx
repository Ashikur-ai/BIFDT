                ...
                <tbody>
                    {
                        subjects.map((subject, idx) => <tr key={subject?.id} className=''>
                            ...
                            <td className="border border-gray-200 px-2 sm:px-4 py-2 font-medium border-b-[1.5px border-b-primary border-r-[2px] border-r-black text-end">{subject.credit} Credits</td>
                            {
