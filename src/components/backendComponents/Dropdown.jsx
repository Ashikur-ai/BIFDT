    ...
    return (
        ...
        <>
            <div className="w-full relative">
                ...
                <div className={`transition-all duration-300 mt-2 ml-4 bg-[#f6861f]/50 border rounded-lg w-full z-10 overflow-hidden ${isOpen ? 'scale-y-100' : 'scale-y-0 absolute'} origin-top `}>
                    {urls}
                </div>
            </div>
        </>
