        ...
        <>
            ...
            <div className='bg-pink-600 text-white '>
                ...
                <div className=' text-white'>
                    <HeaderText className={'text-white font-bold text-3xl text-center'} title="Online Admission Form"></HeaderText>
                </div>
                    ...
                    <section className="text-gray-600 body-font relative">
                        <div className="container px-5  mx-auto">
                            <div className="flex flex-col text-center w-full ">
                                <p className="lg:w-full mx-auto text-white leading-relaxed text-sm pb-2">Unlock Your Creative Potential and Transform Your Fashion Dreams into Reality—Enroll Today!</p>
                            </div>
